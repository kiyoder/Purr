...
const VolunteerDashboard = () => {
    ...
    const fetchVolunteerOpportunities = async () => {
        try {
            ...
            // Check if user exists and userId is valid
            ...
            // Filter opportunities where creatorId matches the userId
            const filteredOpportunities = response.data.filter(opportunity => opportunity.creatorId === userId);
    
            // Set the filtered opportunities to state
            setVolunteerOpportunities(filteredOpportunities);
        } catch (error) {
                    ...
                    <Grid item xs={12} sm={6} md={4} key={opportunity.opportunityID}>
                        <Card variant="outlined" sx={{ height: '100%' }}>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2">Description: {opportunity.description.slice(0, 79)}</Typography>
